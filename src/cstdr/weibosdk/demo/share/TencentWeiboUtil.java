...
public class TencentWeiboUtil {
    ...
    public void auth(final WeiboListener l) {
        long appId=Long.valueOf(com.tencent.weibo.sdk.android.api.util.Util.getConfig().getProperty(Constants.TX_APP_KEY));
        String appSecket=com.tencent.weibo.sdk.android.api.util.Util.getConfig().getProperty(Constants.TX_APP_KEY_SEC);
        listener=l;
        ...
        AuthHelper.register(mContext, appId, appSecket, new OnAuthListener() {
            ...
            public void onAuthPassed(String name, WeiboToken token) {
                ...
                String clientId=com.tencent.weibo.sdk.android.api.util.Util.getConfig().getProperty(Constants.TX_APP_KEY);
                String clientIp=getClientIp();
                PreferenceUtil.getInstance(mContext).saveString(Constants.PREF_TX_ACCESS_TOKEN, token.accessToken);
                PreferenceUtil.getInstance(mContext).saveString(Constants.PREF_TX_EXPIRES_IN, String.valueOf(token.expiresIn));
    ...
    private void getUserInfo(final WeiboListener l) {
        ...
        weiboAPI.getUserInfo(new RequestListener() {
            ...
            public void onError(WeiboException arg0) {
                LOG.cstdr(TAG, "onError = " + arg0.getMessage());
            }
     ...
     * @param compatibleflag 容错标志，支持按位操作，默认为0。 0x20-微博内容长度超过140字则报错 0-以上错误做容错处理，即发表普通微博 不是必填
     * @param listener 回调函数
     */
        ...
        weiboAPI.addWeibo(content, longitude, latitude, syncflag, compatibleflag, new RequestListener() {
            ...
            public void onIOException(IOException e) {
                ...
                MainActivity.getHandler().post(new Runnable() {
                    ...
                    @Override
                    public void run() {
                        Util.showToast(mContext, "分享失败，请检查网络连接。");
                    }
                });
            }
